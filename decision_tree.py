...
feature_names = encoder.get_feature_names_out(['Outlook', 'Temperature', 'Humidity', 'Windy'])

# Convert the feature names array to a list
feature_names_list = feature_names.tolist()

# Visualize the ID3 decision tree
plt.figure(figsize=(12, 8))
plot_tree(clf_id3, filled=True, feature_names=feature_names_list, class_names=['No', 'Yes'])
plt.show()
...
plt.figure(figsize=(12, 8))
plot_tree(clf_cart, filled=True, feature_names=feature_names_list, class_names=['No', 'Yes'])
plt.show()
